...
class DevsecopsTicket(Base):
    ...
    """Specialization name (e.g. 'FE', 'DevSecOps'). Matched against specializations.specialization_name."""
    status_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("statuses.status_id"))
    """FK to statuses table. Defaults to Inactive on creation."""
    ...
    """Timestamp when the project was first flagged as At Risk."""
