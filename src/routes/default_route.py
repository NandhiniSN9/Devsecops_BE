...
liveness (/health) and readiness (/ready) signals for the service.
"""
...
async def health_check() -> JSONResponse:
    ...
    try:
        ...
        logger.exception("Unexpected error in health check endpoint")
...
async def readiness_check(
    ...
    try:
        ...
        logger.warning("Readiness check failed: database connectivity issue")
